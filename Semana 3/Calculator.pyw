...
class App:
    def __init__(self,master):
        ...
        self.master.geometry("320x290+100+100")
        ...
        #Wifgets de la calculadora
        self.entDisplay = tk.Entry(frm, width=12, font = '"Digital-7 Mono" 20', bd =3,
        textvariable=self.var_num, justify=tk.RIGHT,
        bg="#E6FFD9")

        self.btn0 = tk.Button(frm,text="0",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command= lambda: self.add_num_display('0'))
        self.btn1 = tk.Button(frm,text="1",width=4, font = "Ariel 16", bg='#A9A9F5', 
                    command=lambda: self.add_num_display('1'))
        self.btn2 = tk.Button(frm,text="2",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('2'))
        self.btn3 = tk.Button(frm,text="3",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('3'))
        self.btn4 = tk.Button(frm,text="4",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('4'))
        self.btn5 = tk.Button(frm,text="5",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('5'))
        self.btn6 = tk.Button(frm,text="6",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('6'))
        self.btn7 = tk.Button(frm,text="7",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('7'))
        self.btn8 = tk.Button(frm,text="8",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('8'))
        self.btn9 = tk.Button(frm,text="9",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('9'))
        self.btnpoint = tk.Button(frm,text=".",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=lambda: self.add_num_display('.'))
        self.btnEqual = tk.Button(frm,text="=",width=4, font = "Ariel 16", bg='#A9A9F5',
                    command=self.solve)
        self.btnAdd = tk.Button(frm,text="+",width=4, font = "Ariel 16", bg='#5858FA', 
                    command=lambda: self.set_operation('+'))
        self.btnSub = tk.Button(frm,text="-",width=4, font = "Ariel 16", bg='#5858FA',
                    command=lambda: self.set_operation('-'))
        self.btnMul = tk.Button(frm,text="x",width=4, font = "Ariel 16", bg='#5858FA',
                    command=lambda: self.set_operation('*'))
        self.btnDiv = tk.Button(frm,text="/",width=4, font = "Ariel 16", bg='#5858FA',
                    command=lambda: self.set_operation('/'))
        self.btnDel = tk.Button(frm,text="Del",width=4, font = "Ariel 16", bg='#FE2E64',
                    command=self.clear_display)

        self.entDisplay.grid(row =0, column=1 ,columnspan=3, padx=5 , pady=5)
        self.btn0.grid(row=4, column=0, padx=2, pady=5)
...
# python calculator.py  (__name__: "__main__")
# import calculator     (__name__: "calculator.py")
